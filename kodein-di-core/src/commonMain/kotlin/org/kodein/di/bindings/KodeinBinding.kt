 ...
 * @param T The type of instance this factory creates or retrieves.
 */
@Deprecated("Deprecated in favor of a new API", replaceWith = ReplaceWith("DIBinding"), level = DeprecationLevel.WARNING)
 ...
 */
@Deprecated("Deprecated in favor of a new API", replaceWith = ReplaceWith("NoArgDIBinding"), level = DeprecationLevel.WARNING)
